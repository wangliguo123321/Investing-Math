...
| 篇号 | 标题 | 核心公式 | 核心问题 | 状态 |
|------|------|---------|---------|------|
| **第11篇** | **[现代投资组合理论：有效前沿的边界](./episodes/第11篇_现代投资组合理论_有效前沿的边界.md)** | Markowitz MPT | 多资产怎么分配最优？ | ✅ 已发布 |
| 第12篇 | 夏普比率：策略质量的标准尺 | $SR = \frac{R_p - R_f}{\sigma_p}$ | 我的策略到底好不好？ | 🔲 待写 |
| 第13篇 | 风险平价：桥水基金的全天候秘密 | $RC_i = w_i \cdot \frac{\partial\sigma}{\partial w_i}$ | 怎样穿越经济周期？ | 🔲 待写 |
| 第14篇 | 最优仓位管理 Optimal-f：凯利进阶版 | TWR 最大化 | 真实交易中仓位怎么算？ | 🔲 待写 |
| 第15篇 | 相关性与分散化：降低风险的数学奥秘 | $\rho_{ij}$ 矩阵 | 哪些资产放一起效果最好？ | 🔲 待写 |
