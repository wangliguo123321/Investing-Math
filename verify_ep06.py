...
def main():
    print("Starting EP06 article verification...\n")
    all_passed = True
    ...
    if all_passed:
        print("\n🎉 ALL VERIFICATIONS PASSED! The EP06 article meets the structural requirements.")
        sys.exit(0)
    else:
        print("\n💥 VERIFICATION FAILED. Please fix the errors.")
        sys.exit(1)
